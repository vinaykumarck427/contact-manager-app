                ...
                <div>
                    <h2 className="h2 text-center text-justify text-uppercase text-center text-primary">User Registration</h2>
                        <form className="form" onSubmit={this.handleSubmit}>
                            ...
                            {/*{this.state.nameErr && <small>{this.state.nameErr}</small>}*/}
                            ...
                            <div className="form-group">
                                ...
                                <input type='password' className="input form-control col-sm-9" name='password' value={this.state.password} onChange={this.handleChange} />{/*{this.state.passwordErr && <small>{this.state.passwordErr}</small>}*/}
                            </div>
